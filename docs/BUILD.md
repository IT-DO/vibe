...
## Путь 1. Скачать готовый APK — без установки инструментов

Каждая успешная сборка публикует APK в релиз с постоянным адресом:

**Releases → `android-latest` → файл `photo-na-pamyat-<номер>.apk`**

Ссылка не меняется от сборки к сборке, файл всегда свежий. Это прямая
загрузка `.apk` — её можно открыть прямо в браузере телефона, распаковывать
ничего не нужно.

Если нужна конкретная сборка, а не последняя: вкладка **Actions** → нужный
прогон «Сборка» → артефакт **`apk`** внизу страницы. Там файл отдаётся
zip-архивом и живёт 30 дней.

Чтобы собрать вручную: **Actions** → «Сборка» → **Run workflow**. Около
10–15 минут на первой сборке, дальше быстрее за счёт кеша.

Файл подписан отладочным ключом: на телефон и планшет ставится, в Google
Play — нет. Для своего ключа см. раздел «Подпись» ниже.

**Установка на телефон или планшет:**
