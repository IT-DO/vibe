 ...
 *
 * То же, что и при настоящей печати: поля раскладок заданы в миллиметрах и
 * округляются до пикселей, поэтому считать тесноту в другом разрешении —
 * значит мерить не тот лист, который уйдёт в принтер.
 */
const DPI = 520;
