 ...
 *
 * Для Xiaomi 1S: 50,8 × 76,2 мм при 520 dpi = 1040 × 1560 пикселей — ровно
 * та область печати, которую ждёт прошивка. Готовим кадр точно под неё:
 * картинку больше принтер не уменьшает, а обрезает по центру.
 */
